      ...
      <main className="relative z-10 max-w-4xl mx-auto p-6">
        ...
        >
          <div className="flex items-center space-x-3 mb-8">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-800">Información de la Rifa</h2>
              <p className="text-slate-600">Completa los detalles para crear una nueva rifa</p>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Input
                  ...
                  onChange={(value: string) => setFormData((prev) => ({ ...prev, maxTickets: value }))}
                  placeholder="100"
                  icon={Ticket}
                  required
                />
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-2">
                  Imágenes del Premio <span className="text-slate-500">(Opcional)</span>
                </label>
                <div
          ...
          <div className="flex items-center justify-between pt-8 mt-8 border-t border-slate-200">
            <div className="text-sm text-slate-500">Los campos marcados con * son obligatorios</div>
            <div className="flex items-center space-x-4">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              { icon: Trophy, label: "Premio", value: formData.name || "Sin especificar" },
              { icon: Ticket, label: "Boletos", value: `${formData.maxTickets || "0"} máximo` },
              { icon: DollarSign, label: "Precio", value: `$${formData.price || "0"} c/u` },
              { icon: Upload, label: "Imágenes", value: `${formData.images.length} subidas` },
