...
import { Plus, Edit3, Trash2, Trophy, Users, DollarSign, Eye, MoreVertical, Search, Filter, Ticket } from "lucide-react"
...
export default function AdminDashboard() {
  ...
  const filteredRaffles = raffles?.filter((raffle) => {
    ...
    const matchesFilter = filterStatus === "all" || raffle.status === filterStatus
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-slate-600 mt-1">Gestiona todas tus rifas desde aquí</p>
            </div>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 inline-flex items-center"
            >
      ...
      <main className="relative z-10 max-w-7xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          {[
            { icon: Trophy, label: "Total Rifas", value: totalRaffles, color: "blue" },
            { icon: Ticket, label: "Rifas Activas", value: activeRaffles, color: "green" },
            { icon: Users, label: "Participantes", value: "2,847", color: "purple" },
            { icon: DollarSign, label: "Ingresos", value: "$45,230", color: "emerald" },
          ...
          <AnimatePresence>
            {filteredRaffles?.map((raffle, index) => (
              ...
              >
                ...
                <div className="relative">
                  <img
                    src={"http://localhost:3000" + raffle.images[0].url || "/placeholder.svg"}
                    alt={raffle.name}
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-slate-600 line-clamp-2">{raffle.description}</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 mb-4">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-semibold text-blue-600">${raffle.price} por boleto</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    <button className="flex-1 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium py-2 px-3 rounded-lg transition-colors inline-flex items-center justify-center text-sm">
                      <Eye className="h-4 w-4 mr-1" />
                      Ver
                    </button>
                    <button className="flex-1 bg-blue-100 hover:bg-blue-200 text-blue-700 font-medium py-2 px-3 rounded-lg transition-colors inline-flex items-center justify-center text-sm">
        ...
        {filteredRaffles?.length === 0 && (
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-2">No se encontraron rifas</h3>
          ...
          >
            ...
            >
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-slate-800 mb-2">¿Eliminar rifa?</h3>
                <p className="text-slate-600 mb-6">
                  Esta acción no se puede deshacer. La rifa y todos sus datos asociados serán eliminados
                  permanentemente.
                </p>
